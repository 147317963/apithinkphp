...
return [
    ...
    // 默认跳转页面对应的模板文件
    'dispatch_success_tmpl'  => \think\facade\Env::get('think_path') . 'tpl/dispatch_jump.tpl',
    'dispatch_error_tmpl'    => \think\facade\Env::get('think_path') . 'tpl/dispatch_jump.tpl',


    // 异常页面的模板文件
    'exception_tmpl'         => \think\facade\Env::get('think_path') . 'tpl/think_exception.tpl',
